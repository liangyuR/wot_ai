...
def CollectHiddenImports() -> List[str]:
    ...
    hidden_imports = [
        ...
        'data_collection.core.config_manager',
        'data_collection.detection',
        'data_collection.detection.game_state_detector',
        'data_collection.detection.yolo_state_detector',
        'data_collection.capture',
        'data_collection.capture.mss_capture',
        'data_collection.capture.dxcam_capture',
        'data_collection.save',
        'data_collection.save.frame_saver',
        'data_collection.save.async_frame_saver',
        'data_collection.save.turbojpeg_saver',
        'data_collection.listeners',
        'data_collection.listeners.global_listener',
        'data_collection.listeners.pynput_listener',
        'data_collection.recording_events',
        'data_collection.recording_overlay',
        'data_collection.global_hotkey',
    ]
