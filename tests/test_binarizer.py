...
try:
    ...
    MinimapBinarizer, _ = try_import_multiple([
        'wot_ai.game_modules.navigation.core.minimap_binarizer',
        'game_modules.navigation.core.minimap_binarizer',
        'navigation.core.minimap_binarizer'
    ])
    if MinimapBinarizer is None:
        from navigation.core.minimap_binarizer import MinimapBinarizer
except ImportError:
