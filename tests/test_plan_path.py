...
try:
    ...
    CvMinimapDetector, _ = try_import_multiple([
        'wot_ai.game_modules.detection.cv_minimap_detector',
        'game_modules.detection.cv_minimap_detector',
        'detection.cv_minimap_detector'
    ])
    if CvMinimapDetector is None:
        from detection.cv_minimap_detector import CvMinimapDetector
except ImportError:
