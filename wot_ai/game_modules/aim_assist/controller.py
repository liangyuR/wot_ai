...
# 导入依赖模块
ScreenCapture, _ = try_import_multiple([
    'wot_ai.game_modules.aim_assist.core.screen_capture',
    'game_modules.aim_assist.core.screen_capture',
    'aim_assist.core.screen_capture'
])
if ScreenCapture is None:
    from .core.screen_capture import ScreenCapture, MssScreenCapture
else:
    from wot_ai.game_modules.aim_assist.core.screen_capture import MssScreenCapture

DetectionEngine, _ = try_import_multiple([
    'wot_ai.game_modules.aim_assist.core.detection_engine',
    'game_modules.aim_assist.core.detection_engine',
    'aim_assist.core.detection_engine'
])
if DetectionEngine is None:
    from .core.detection_engine import DetectionEngine

AimController, _ = try_import_multiple([
    'wot_ai.game_modules.aim_assist.core.aim_controller',
    'game_modules.aim_assist.core.aim_controller',
    'aim_assist.core.aim_controller'
])
if AimController is None:
    from .core.aim_controller import AimController

HotkeyManager, _ = try_import_multiple([
    'wot_ai.game_modules.aim_assist.core.hotkey_manager',
    'game_modules.aim_assist.core.hotkey_manager',
    'aim_assist.core.hotkey_manager'
])
if HotkeyManager is None:
    from .core.hotkey_manager import HotkeyManager

AimConfigManager, _ = try_import_multiple([
    'wot_ai.game_modules.aim_assist.core.config_manager',
    'game_modules.aim_assist.core.config_manager',
    'aim_assist.core.config_manager'
])
if AimConfigManager is None:
    from .core.config_manager import AimConfigManager

AimAssist, _ = try_import_multiple([
    'wot_ai.game_modules.aim_assist.aim_assist',
    'game_modules.aim_assist.aim_assist',
    'aim_assist.aim_assist'
])
if AimAssist is None:
