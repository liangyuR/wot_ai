...
from wot_ai.game_modules.aim_assist.controller import AimAssistMainController
from wot_ai.game_modules.aim_assist.core.config_manager import AimConfigManager
